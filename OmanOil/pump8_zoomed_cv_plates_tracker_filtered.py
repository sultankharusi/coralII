...
def get_scaled_box(box, yscale=0.6, xscale=0.2, box_only = False):
...
def plate_inference(plate,V_box,yscale=0.6,xscale=0.2): # OmanOil yscale 1.22, xscale 0.36 # Video is yscale=0.96,xscale=0.256
