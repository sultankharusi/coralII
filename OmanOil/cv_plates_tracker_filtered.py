...
def main():
    ...
    while True:
        ...
        if not ret:
            break
        cv2_im_cropped = frame[170:504,160:1320] #170:504 (1.15), 160:1320 (0.33) *Orig* 190:504,235:1300 This is a global variable and shall never be altered, so cv2_im_cropped is never augmented after this point
        ...
        if objs:
            ...
            plate_list = {}
            for i in objs:
                if i[0] in filtered and i[2][3] >= 295 and i[2][3] <=370:    
